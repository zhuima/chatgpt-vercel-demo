...
> 本项目基于 [chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) 


> **Warning**
>
> API Key 已经被封完了，请自行部署。现在 OpenAI 的 5$ 免费账号巨容易封，不建议再部署到 Vercel 或者其他平台上了，要部署请直接国外 VPS。切记一个 IP 一个 Key，不要搞轮询。18$ 或者绑卡账号目前还没有这些问题。1
